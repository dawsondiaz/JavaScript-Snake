    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmAboutPanel.innerHTML = "<a href='http://patorjk.com/blog/software/' class='snake-link'> Originally Created by patorjk.com</a> - <a href=http://dawsondiaz.com class='snake-link'>Modified by Dawson Diaz</a>";
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "Oelsch Snake<p></p>Use the <strong>arrow keys</strong> on your keyboard to play the game. " + fullScreenText + "<p></p>";
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "Oelsch Snake<p></p>You died. Oelsch is very disappointed in you. :(<p></p>";
